...
| D-platform | Nền tảng và chiến lược client | React Native cross-platform | M1 | `05-architecture.md` |
| D-overview | Hướng triển khai tổng quan (offline/sync) | Offline-first với SQLite sync | M2 | `05-architecture.md` |
| D-distribution | Phân phối và phát hành store | Camera và Photo Library access | M3 | `07-release.md` |
| D-auth | Xác thực và phân quyền | FCM push notifications | M4 | `05-architecture.md` |
| D-realtime | Realtime, push hoặc đồng bộ | TestFlight beta trước, thu phí IAP | M5 | `05-architecture.md` |
