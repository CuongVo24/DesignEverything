...
|---|---|---|---|---|
| D-shape | Hình-hài dự án | cli | S7 | `06-constraints.md` |
...
| D-overview | Hướng triển khai tổng quan | Node.js (TypeScript) | C1 | `05-architecture.md` |
| D-interface | Giao diện dòng lệnh | flags/arguments và interactive prompts | C2 | `05-architecture.md` |
| D-config | Cấu hình và quản lý khóa bí mật | file config JSON ~/.config/myapp.json và ENV | C3 | `05-architecture.md` |
| D-platform | Hệ điều hành hỗ trợ đầu tiên | cross-platform macOS, Linux, Windows | C4 | `05-architecture.md` |
| D-distribution | Kênh phân phối | NPM registry | C5 | `07-distribution.md` |
