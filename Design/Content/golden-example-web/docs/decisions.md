...
| D-rendering | Giao diện và chiến lược rendering | Next.js SSR cho SEO | W1/W2 | `05-architecture.md` |
| D-overview | Hướng triển khai tổng quan | Responsive mobile-first | W2 | `05-architecture.md` |
| D-hosting | Hosting và đường phát hành | Triển khai lên Vercel | W3 | `07-deployment.md` |
| D-auth | Xác thực và phân quyền | NextAuth Google OAuth | W4 | `05-architecture.md` |
| D-realtime | Realtime, push hoặc đồng bộ | Không realtime ở MVP | W5 | `05-architecture.md` |
