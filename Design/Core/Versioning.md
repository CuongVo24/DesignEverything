...
| 2.0.0 (spec khoá B2 — chưa phát hành) | 2026-06-29 | Mở `branch` thành hình-hài dự án (registry ở taxonomy); thêm `kind: anchored\|meta`; tách câu chọn hình-hài `S7` khỏi S6; thêm shape `cli` + `07-distribution.md`; critic role + meta-calibrate. **MAJOR** — xem [V2-ExpansionPlan](../RoadMap/V2-ExpansionPlan.md), DecisionLog D21–D26. | Claude Code + AGENTS.md (đồng bộ khi code B5–B6) |
