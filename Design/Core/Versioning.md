...
| 7.0.0 | 2026-07-25 | v1-fix-bugs Release Truth Sync: Tích hợp runtime installed-runtime adversarial integration (B5a), state/emit transaction fault injection (B5b), newbie journey evaluation (B5c), shared parity runner giữa Claude Code và Codex (B4e), loại bỏ 100% link `file:///e:/...` và kiểm tra sự thật runtime (B5d). **MAJOR**. | Claude Code + Codex + AGENTS.md |
