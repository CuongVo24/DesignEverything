...
| # | File | Khi nào |
|---|------|---------|
| 6 | `Design/Core/Schemas/interview-script.md` | Khi đụng kịch bản phỏng vấn |
| 7 | `Design/Core/Schemas/state-schema.md` | Khi đụng `progress.json` / state machine |
| 8 | `Design/Core/Schemas/gate-policy.md` | Khi đụng logic GATE / hook |
| 9 | `Design/Core/AnchorFormat.md` | Khi đụng mỏ neo truy vết trong output |
| 10 | `Design/Content/taxonomy.md` | Khi đụng cây doc đầu ra (EMIT) |
| 11 | `Design/Content/interview-script/README.md` | Khi mài nội dung S0–S6 / W / M |

**Tài liệu adapter & quy ước — đọc khi code:**

| # | File | Khi nào |
|---|------|---------|
| 12 | `Design/Adapters/ConformanceMatrix.md` | Trước khi viết/sửa bất kỳ adapter nào |
| 13 | `Design/Adapters/claude-code.md` / `agents-md.md` | Khi code adapter tương ứng |
| 14 | `Design/Conventions/TechStack.md` | Stack khoá cứng (cấm import lậu) — Node/TS | Luôn đọc khi code |
| 15 | `Design/Conventions/Coding & Git Standard.md` | Luôn đọc khi code |
| 16 | `Design/Content/QualityRubric.md` | Khi viết/chấm nội dung doc |
| 17 | `Design/Conventions/TestStrategy.md` | Trước khi test (3 tầng) |
| 18 | `Design/RoadMap/MasterRoadMap.md` | Biết đang ở mốc nào, scope ra sao |
| 19 | `Design/DecisionLog.md` | Khi phân vân vì sao đã chọn thế này |
...
|---|---|---|---|
| 1 | **Code adapter trước khi khoá lõi** | Viết hook/skill khi `Core/Contract.md` hoặc schema còn DRAFT | STOP. Khoá `Core/` + Approve trước. Đây là gate cốt lõi của chính sản phẩm. |
