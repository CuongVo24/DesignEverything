...
| 4 | `Design/Core/Contract.md` | Hợp đồng Lõi↔Adapter (public API) | Luôn đọc |
| 5 | `Design/Core/Versioning.md` | Cách đổi lõi mà không vỡ adapter | Luôn đọc |
...
| 14 | `Design/Conventions/Coding & Git Standard.md` | Luôn đọc khi code |
| 15 | `Design/Conventions/TestStrategy.md` | Trước khi test (3 tầng) |
| 16 | `Design/RoadMap/MasterRoadMap.md` | Biết đang ở mốc nào, scope ra sao |
