...
## 3. Checklist
- [x] F-04, F-07 trong backlog có trạng thái mới trỏ đúng W13A/W13B + lý do trượt.
- [x] pain-rank có ghi chú đính chính, không xoá Action Plan gốc.
- [x] D20 ghi rõ lỗ hổng quy trình + biện pháp (gắn tầng vào action plan).
- [x] Mọi link chéo (backlog ↔ pain-rank ↔ contract W13A/B) còn sống.
