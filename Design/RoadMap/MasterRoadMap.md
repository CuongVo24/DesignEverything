...
- **Phase 8 — chuỗi gate 7.0.0 → 8.0.0 → 8.1.0:** `v1-fix-bugs` (7.0.0, BLOCKED) → `v6-expansion` (8.0.0, lane chưa mở) → Interactive Question Cards (8.1.0, lane chưa mở). Bảng mốc và bằng chứng xuyên phiên: [MasterSequencingPlan.md](MasterSequencingPlan.md).
