...
Responsive layout sử dụng CSS Grid để co giãn trên mobile.
...
React + Vite (SPA) kết hợp Supabase client-side API để triển khai nhanh gọn.
...
Supabase Auth (Email/Password và Google OAuth).
...
Reload trang để cập nhật trạng thái; không cần WebSocket/Realtime ở MVP.
