...
8. `07-release.md` — xem đường phát hành phù hợp với di động.
<!-- anchor: id=docs-readme/reading-order  src=apps/mobile/src/features/docs/readme.ts::readingOrder  rev=  status=planned -->

## Tóm Tắt Nhanh Dự Án
HabitBuilder Mobile App - ứng dụng di động giúp xây dựng và theo dõi thói quen hàng ngày dành cho cá nhân và đối tác cùng rèn luyện.
...
Chạy Android: `npx expo start --android`. Chạy iOS: `npx expo start --ios`. Chạy tests: `npm test`.
