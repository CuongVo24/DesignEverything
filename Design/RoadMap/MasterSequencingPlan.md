...
| **Gate A1** | Nâng 22 contract `v1-fix-bugs` PARTIAL → IMPLEMENTED (P2→P10 của `plan-v1-fix.md` §6) | ⏳ TODO | Cột Implementation `v1-fix-bugs/README.md` — hiện 12/24 (B1a, B1b, B1c, B1d, B2a, B2d, B2e, B3c, B3d, B4d, B4e, B4f) |
...
| ↳ A1-P6 | B3a/B3b/B3c — answer/slots/provenance/catalog | ⏳ Một phần đóng 2026-08-03 | U05/X12 key-scope phần đóng (chung R07); U06/X23 user-visible artifact đóng, acknowledgement-gate hoãn sang A1-P7. B3a checklist đối chiếu lại code: nhiều mục đã đúng từ trước (pattern/min_items/enum, answer immutability by construction, capability non-consumption). Còn mở: slots envelope enrichment, scratch-path confinement cho --slots-file |
